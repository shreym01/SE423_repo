...
Quaternion_ = struct.Struct( '<ffff' ) # modify to Quaternion_ to avoid comfusion with the class -YL
...
class NatNetClient:
    ...
    def __unpack_rigid_body( self, data, major, minor, rb_num):
        ...
        quat = Quaternion()
        quat.w, quat.x, quat.y, quat.z = rot
...
#Unpack Mocap Data Functions
    ...
    def __unpack_rigid_body_data( self, data, packet_size, major, minor):
        ...
        for i in range( 0, rigid_body_count ):
            ...
            offset += offset_tmp
            # only add to the list when the tracking is valid - YL
    ...
    def __unpack_camera_description(self, data, major, minor):
        ...
        # Orientation
        orientation = Quaternion_.unpack( data[offset:offset+16] )
        offset += 16
